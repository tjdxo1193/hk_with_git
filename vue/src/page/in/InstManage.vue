<template>
  ...
  />
  <ActionBar :buttons="printButtons.buttons" @button-click="onClickPrintButtons">
...
export default {
  ...
  data() {
    const { searchGridWithForm, registerForm, accessoryGrid, printButtons } = this.$copy(values);
    return {
      searchGridWithForm: {
