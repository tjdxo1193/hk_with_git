...
import lims.api.sy.entity.DepartmentManageEntity;
...
public interface DepartmentManageDao {
    ...
    @Audit(target = DepartmentManageEntity.class, label = AuditEvent.Department.create)
    int insert(DepartmentManageVO vo);

    @Audit(target = DepartmentManageEntity.class, label = AuditEvent.Department.update)
