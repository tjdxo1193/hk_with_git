...
@Getter
@Setter
public class ReagentMaterialVO implements UpdateDetect {
    ...
    private String regVolUnitNm;
    private String regCtetUnitCd;
    private String regCtetUnitNm;
