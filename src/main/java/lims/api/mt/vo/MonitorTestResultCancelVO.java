...
@Getter
@Setter
public class MonitorTestResultCancelVO implements UpdateDetect {
    ...
    private String hldRea; //보류사유
    private String hldCanlDs; //보류취소일
    private String hldCanlUnm; //보류취소자
    private String hldCanlRea; //보류취소사유
