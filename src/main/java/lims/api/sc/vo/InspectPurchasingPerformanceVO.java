...
public class InspectPurchasingPerformanceVO {
    ...
    /* 별칭 */
    private Integer fiscalYr;       // 회계 연도
    private String month;           // 월
    private Integer ansCnt;         // 검사 횟수
    private String date;            // 회계연도 + 월
    private Integer etrQty;         // 입고량
    private String istReqNo;        // 검사 요청 번호
    private Character ifYn;         // 연계 여부
    private String ifDs;            // 연계 일시
    private Character ftnYn;        // 기능성 여부
}
