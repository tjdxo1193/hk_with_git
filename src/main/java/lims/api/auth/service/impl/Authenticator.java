...
public class Authenticator {
    ...
    public TokenAuthentication authenticate(AccountAuthentication authenticationToLogin) {
        ...
        return authenticated(authenticationToLogin.toSafeAuthentication());
    }

    public TokenAuthentication authenticated(SafeAccountAuthentication authentication) {
    ...
    private TokenAuthentication createAuthentication(Claims customClaims) {
        ...
        return new TokenAuthentication(accessToken, refreshToken, customClaims);
    }
