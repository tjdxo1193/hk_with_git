...
public class HttpHelper {
    ...
    public static ESignVO getESignAtRequestHeader() {
        String param = URLDecoder.decode(getRequestHeader(E_SIGN_HEADER_NAME), StandardCharsets.UTF_8);
        return new Gson().fromJson(param, ESignVO.class);
    }
