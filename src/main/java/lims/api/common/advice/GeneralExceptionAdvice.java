...
public class GeneralExceptionAdvice {
    ...
    @ExceptionHandler({MismatchedPasswordConditionException.class})
    public ResponseEntity<ErrorResponse> MismatchedPasswordConditionException(MismatchedPasswordConditionException e) {
