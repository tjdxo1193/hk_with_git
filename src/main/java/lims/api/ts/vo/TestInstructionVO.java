...
@Getter
@Setter
public class TestInstructionVO implements UpdateDetect {
    ...
    private String clltMtdNm; //채취 방법
    private String clltMcnNm; //채취 기구
    private String clltPlaNm; //채취 장소
    private String smpStrgMtdNm; //검체 보관 방법
    private String smpVolUnitNm; //검체량 단위
    private String smpVolAns; //검체량 시험
    private String smpVolEtc; //검체량 기타
    private String smpVolStrg; //검체량 보관
