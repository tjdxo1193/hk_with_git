...
public class TestRequestServiceImpl implements TestRequestService {
    ...
    public List<TestRequestVO> getTestList(TestRequestVO request) {
        ...
        processList.add(0, TestProcess.TEST_REQUEST.getProcessCode());
        processList.add(1, TestProcess.TEST_RECEIPT.getProcessCode());
        processList.add(2, TestProcess.TEST_CANCEL.getProcessCode());
